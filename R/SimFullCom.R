...
#'
#' @description This function simulates Nsim fully determined communities
...
#'
#' @param Data2fill datatable of the dataset for which the gap filling of
#' botanical names from vernacular names will be done. This dataset must
#' have been prepared using the function PrepData.
#' @param DataAsso datatable of the dataset that will be used to built the
...
#' @param Determ boolean: if TRUE the more likely botanical names are return when
...
#'       - Det2Genus: identified to the genus => the corrected name is of
#'        the form Genus-Indet. (so we keep the botanically identified genus name
#'         and say that the species is Indet.)
#'       - Det2Fam: identified to the family => the corrected name is of the form
...
#'       - AssoByGenus, AssoByGenusDeterm and AssoByGenusDetermT: a full identification
...
#'       - AssoByFam, AssoByFamDeterm and AssoByFamDetermT: a full identification
#'       is given with the method of association with the vernacular name using a
#'       Dirichlet-Categorical scheme described (if Determ is set to FALSE) or with the
#'        more likely association (if Determ is set to TRUE), limiting the possibility
#'        to the species of the same family
#'       - AssoByVerna, AssoByVerna and AssoByVernaT: full identification is given with
...
#'  - get a data.table containing the matrix of posterior Alpha (using function CreateAlpha)
