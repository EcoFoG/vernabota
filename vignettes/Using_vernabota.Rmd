...
## Example 2: using different dataset for Data2fill and DataAsso, with a prior (different weighing of the prior and the observation)
...
> A faire, mettre une phrase d'intro et ne donner qu'un seul exemple où on fait varier
plusieurs trucs comme dans ex de Mélaine
