...
It is largely based on the work and codes from @Aubry-Kientz2013 and @Mirabel2018.
...
devtools::install_github("EcoFoG/vernabota")
```
...
We use the function PrepData (see description below) to prepare the data.
...
## Example 1: using the same dataset for Data2fill and DataAsso (subplot 1), without prior
