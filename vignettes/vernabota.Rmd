...
In cases where the original data contained several censuses of a same plots (*i.e.* several lines
per individual trees), the output contained in *results* keeps only one line per individual,
and only a subset of colums from the original dataset (thes ones that don't change between censuses).
